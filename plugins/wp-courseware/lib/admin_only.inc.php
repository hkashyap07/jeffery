...
function WPCW_questions_questionType_Actions()
{
	$question_types = apply_filters( 'wpcw_question_types', array(
		'multi'     => __( 'Multiple Choice', 'wp_courseware' ),
		'truefalse' => __( 'True / False', 'wp_courseware' ),
		'open'      => __( 'Open Ended', 'wp_courseware' ),
		'upload'    => __( 'File Upload', 'wp_courseware' )
	) );
	...
	// Select
	$html .= sprintf('<label for="wpcw_questions_question_type_actions">%s</label>', __('Add Question:', 'wp_courseware'));
	$html .= '<select name="question_type" class="wpcw_question_type_action">';
		$html .= sprintf( '<option value="" selected="selected">%s</option>', __( 'Select Question Type', 'wp_courseware' ) );
	...
	// CTA
	$html .= sprintf('<input type="submit" class="button-secondary" value="%s" />', __('Add', 'wp_courseware'));
	return $html . '</form></div>';
}
...
function WPCW_units_metabox_showContentDripSelectionTool()
{
	...
	$delayOptions = array(
		'' 					=> '--- ' . __('No Delay', 'wp_courseware') .  ' ---',
		'drip_specific' 	=> __('On a specific date', 'wp_courseware'),
		'drip_interval' 	=> __('A specific interval after the course start date', 'wp_courseware'),
	);

	$intervalOptions = array(
		'interval_hours' 	=> __('Hour(s)', 'wp_courseware'),
		'interval_days' 	=> __('Days(s)', 'wp_courseware'),
		'interval_weeks' 	=> __('Weeks(s)', 'wp_courseware'),
		'interval_months' 	=> __('Months(s)', 'wp_courseware'),
		'interval_years' 	=> __('Years(s)', 'wp_courseware'),
	);
	...
	printf('<div class="wpcw_units_drip_section">');
		printf('<label for="wpcw_units_drip_type">%s</label>', __('When should this unit become available?', 'wp_courseware'));
	...
	printf('<div class="wpcw_units_drip_section wpcw_datepicker_wrapper" id="wpcw_units_drip_type-drip_specific">');
		printf('<label for="wpcw_units_drip_date">%s</label>', __('Select the date on which this unit should become available...', 'wp_courseware'));
	...
	printf('<div class="wpcw_units_drip_section" id="wpcw_units_drip_type-drip_interval">');
		printf('<label for="wpcw_units_drip_interval">%s</label>', __('How long after the user is enrolled should this unit become available?', 'wp_courseware'));
