...
function WPCW_showPage_Certificates_load()
{
	...
	printf('<div class="wpcw_btn_centre"><a href="%s" target="_blank" class="button-primary">%s</a></div>', add_query_arg( array( 'page' => 'wpcw_pdf_create_certificate', 'certificate' => 'preview' ), esc_url( site_url( '/' ) ) ), __('Preview Certificate', 'wp_courseware'));
